...
from digestapi.models import Book, BookCategory
...
class BookSerializer(serializers.ModelSerializer):
    ...
    def get_is_owner(self, obj):
        ...
        # in order to do this, the request object needs to be provided as context for the serializer
...
class BookViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        serializer = BookSerializer(
            books, 
            many=True, 
            context={'request': request} # allows serializer to access request
        )
    ...
    def create(self, request):
        ...
        category_ids = request.data.get('categories', []) # get the list of integers from the request payload
        book.categories.set(category_ids) # assign categories to the new book
